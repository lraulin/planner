...
description: Rebuild agent-os/standards/index.yml so it matches the standards files on disk. Use after any standard is added, removed, or renamed, and when the user invokes /index-standards or $index-standards.
---
