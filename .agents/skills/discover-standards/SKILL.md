...
description: Extract stable, reusable Planner codebase patterns into concise Agent OS standards. Use when the user asks to document a recurring convention, when the same pattern keeps recurring across the codebase, or when they invoke /discover-standards or $discover-standards.
---
...
- **Always use the structured question tool** when asking the user anything. References
  ...
  question instead. Prefer options the user can confirm, choose between, or correct.
