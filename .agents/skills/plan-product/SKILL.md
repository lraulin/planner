---
name: plan-product
description: Establish or revise the Planner mission, roadmap, and tech-stack docs under agent-os/product/. Use when the user asks to define or revisit product direction, or invokes /plan-product or $plan-product.
---
