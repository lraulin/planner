...
_Source: <http://www.effexis.com/achieve/achieve-planner-faq.htm>_

Community/product FAQ from the Effexis site. Useful for edge cases and intended defaults.

---

---

Frequently Asked Questions (FAQ) This page provides answers to common questions related to the Achieve Planner (AP) software.
...
We realize that many people use more than one computer. We have designed our licensing agreement to be reasonable and flexible. If you have any questions regarding licensing, please do not hesitate to contact us by [submitting a ticket](support/index.md#SubmitTicket).
**Single-User License**
...
3. Use your existing permanent registration code (code received via email) to unlock the software and register it on the new PC.
   NOTE: Starting with version 1.5.2.2, you can view your full permanent registration code in the Help->About dialog. Older versions only display a partial code which cannot be used when transferring AP from one PC to another.
...
5. The first time you run Achieve Planner on the new PC, you will need to open the data file manually. Use the File->Open->Open Data File menu command and select the Achieve Planner data file on your new PC.
   NOTE: You can still keep a copy of Achieve Planner on your old PC if you will be the only one using it, otherwise please [uninstall it](#Install_Uninstall_FAQ).
   ...
   **Q: Why haven't I received my permanent registration code?**
   ...
   If you still can't find your permanent registration code, please go here to [submit a ticket](support/index.md#SubmitTicket) and include as much information as possible about your order including, your order number, name, email address, and any other information that could help us locate your order.
   ...
   **Q: I lost my registration code, how can I get it back?**
   If you lost or can't find your permanent registration code, please [submit a ticket](support/index.md#SubmitTicket) and provide as much information as possible so we can locate your order.
...
6. Select all the text in the email containing your registration code (Ctrl+A)
7. Copy it to the clipboard (Ctrl + C)
   **In Achieve Planner:**
8. Invoke Help->Registration menu item
9. Click on the Register button
10. Make sure that both the user name and registration code in the appropriate boxes match the values from the email message.
...
11. Click OK to complete the registration
    ...
    **Q: How can I upgrade to the latest version of Achieve Planner?**
    The [ Achieve Planner download area](planner.md) contains the latest released version of Achieve Planner.
...
12. Close all running instances of Achieve Planner
13. Download the installer to your PC [ from the download area](download.md)
14. Double-click to run the installer from your PC - This will automatically upgrade your Achieve Planner version to the latest value
...
15. Start Achieve Planner - If the data file format has changed, your data file may need to be converted to the new format. This should happen automatically
    ...
    **Q: How do I find out what's new in each version of Achieve Planner?**
    Take a look at the [ What's New with Achieve Planner](whats-new.md) page, where we post new features/fixes for each release.
    ** Q: How do I download older versions of Achieve Planner?**
    ...
    If there is a compelling reason why you need an older version, please [submit a ticket](support/index.md#SubmitTicket).
    ...
    **Q: What is the Microsoft .NET Framework?**
    ...
    If you prefer you can also download and install the Microsoft .NET Framework directly from Microsoft ([click here](http://www.microsoft.com/downloads/details.aspx?FamilyId=262D25E3-F589-4842-8157-034D1E7CF3A3&displaylang=en "Download .NET Framework Runtime") for the download page).
    **IMPORTANT for Windows Vista/Windows 7 Users:** Achieve Planner currently requires the Microsoft .NET Framework version 1.1.
    ...
    You can get the installer directly from Microsoft ([click here](http://www.microsoft.com/downloads/details.aspx?FamilyId=262D25E3-F589-4842-8157-034D1E7CF3A3&displaylang=en "Download .NET Framework Runtime") for the download page). You don't have to re-install Achieve Planner after you've installed the framework.
    ...
    **Q: Does Achieve Planner sync with Microsoft Outlook?**
    ...
    You can get the user manual from within AP (use Help->User Manual command) or by [visiting our training center](training/index.md).
    **Q: Does Achieve Planner sync with PocketPC?**
    ...
    The sync is currently in beta test. [You can participate in the beta test here](beta/achieve-planner-PI-sync-beta.md).
...
16. Use the Help -> Detect and Repair menu in Outlook and follow instructions. Please check Outlook documentation before doing this advanced procedure.
    **Workaround:**
    Some users have reported that the following workaround seems to solve many Outlook Sync problems...
17. Close Achieve Planner and Outlook
18. Check the Processes tab of the Task Manager and look for any remaining instances of Outlook (OUTLOOK.EXE) that may still be running. If you find any, please wait 5 seconds and then end the process.
19. Start Outlook again
20. Start Achieve Planner
    ...
    ** Q: I'm getting an error that says "RPC server unavailable"?**
    This typically means that Achieve Planner is having problems communicating with Outlook. Please [try the workaround mentioned above](#OutlookSyncWorkaround) and see if it solves the problem.
    **Q: I'm getting a problem report when I try to sync with Outlook?**
    If the problem report is not related to the above two cases and persists even after you [try the workaround mentioned above](#OutlookSyncWorkaround), please send us the problem report and include your email so that we can contact you.
    If the problem occurs during the Task Sync process, try this workaround:
21. Go to the Outlook Tasks screen (in Outlook Go -> Tasks menu item)
22. Select Simple List view and remove any grouping and filtering
23. Select the Actions -> Save Task Order menu item (in Outlook)
...
24. Go to the corresponding tab in the main Achieve Planner window.
    For example, if you want to print the details of a Project, go to the Projects tab (Go->Projects)
25. Select the row of the project for which you want to print additional details
26. Select File -> View Report menu item
...
27. Go to the Weekly Schedule tab (Go -> Weekly Schedule)
28. Select the File -> Print (or File -> Print Preview) menu item - This will print a graphical display of the weekly schedule similar to what you see on the screen
    or
29. Select File -> View Report to print a text-only report of appointments and events
...
30. Use Tools -> Options menu item to display dialog
31. Under Grids tab, check the "Grid Print Font" box to specify a custom print font
32. Select the desired font and size
...
33. Backing up your data file and moving it to a different media (disk, other hard drive, flash card, etc.) - If your hard drive crashes, do you have a relatively recent copy of your data file in some other media?
34. Move important data to a different location - If your PC and backup media are damaged in a house fire, flood, or other disaster, do you have backups in some other location (online, other building, etc.)?
    ...
    **Q: Are you planning to add a 'Personal Journal' module to the software in the near future?**
    ...
    We recommend this one: [ www.effexis.com/journal/journal.htm](../journal/journal.md)
    Common Problems
    **Q: I'm getting a weird problem report that says, "Font Arial doesn't support style Regular" (font& style names vary)?**
    ...
    If you don't have access to a font file or need further help with this, please [submit a ticket](support/index.md#SubmitTicket).
    ** Q: I'm getting a strange error that says "Overflow or underflow in the arithmetic operation"**
    ...
    If you are not able to resolve the problem, please [submit a ticket](support/index.md#SubmitTicket).
...
35. If you've installed Achieve Planner to a directory on your Server, please try installing it directly on your PC rather than on a network server.
    This is a limitation of the .NET security settings on your local area network.
36. Try adjusting the .NET Security Settings:
    ...
    **Q: How do I re-install the .NET Framework v 1.1?**
    ...
    Here's how to do it:
37. Close Achieve Planner (and any other application that may be running)
38. Go to Start->Control Panel->Add/Remove Programs
39. Find the Microsoft .NET Framework 1.1 entry
40. Click on the Remove button to uninstall it - this may take a few minutes
41. Download the Microsoft .NET Framework 1.1 installer from Microsoft
    <
    [_http://www.microsoft.com/downloads/details.aspx?FamilyId=262D25E3-F589-4842-8157-034D1E7CF3A3 &displaylang=en_](http://www.microsoft.com/downloads/details.aspx?FamilyId=262D25E3-F589-4842-8157-034D1E7CF3A3&displaylang=en)>
42. Run the .NET Framework installer - This should reinstall the .NET framework 1.1 (which could take several minutes)
43. Try launching Achieve Planner again (no need to reinstall it)
    If the problem persists, please [submit a support ticket](support/index.md#SubmitTicket).
