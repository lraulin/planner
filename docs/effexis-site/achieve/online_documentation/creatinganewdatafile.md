---
source_url: "http://www.effexis.com/achieve/online_documentation/creatinganewdatafile.htm"
title: "Achieve Time Management & Goal Setting Software Help - Creating a New Data File"
scraped_at: 2026-08-03T15:15:05Z
---

# Achieve Time Management & Goal Setting Software Help - Creating a New Data File

_Archived from [http://www.effexis.com/achieve/online_documentation/creatinganewdatafile.htm](http://www.effexis.com/achieve/online_documentation/creatinganewdatafile.htm)_

---

**_To create a new data file:

· Invoke the **File New Data File** command from the [file menu](filemenu.md).
A new untitled data file will be created.
See Also
