---
source_url: "http://www.effexis.com/achieve/whats-new.htm"
title: "What's New in Achieve Planner"
scraped_at: 2026-08-03T15:15:05Z
---

# What's New in Achieve Planner

_Archived from [http://www.effexis.com/achieve/whats-new.htm](http://www.effexis.com/achieve/whats-new.htm)_

---

# What's New in Achieve Planner

[Click here for instructions on installing the latest version](install-latest-version.md).
**Achieve Planner 2.5.0**
...
Major: Enhancements to Google Calendar & important updates based on changes in Google's interface ([click here for more details](GoogleCalendarSync))
Other bugfixes and enhancements
**Achieve Planner 2.2.1**
Major: Google Calendar Sync support ([click here for more details](GoogleCalendarSync))
...
Note: This release may require an upgrade fee for existing 1.x customers. [Click here](new-version-upgrade.md) for upgrade details.
...
Bugfix: [Note blank line duplication problem with Outlook sync](support/NoteLineDuplication/index.md) (causes huge files and slow performance)
**Achieve Planner 1.9.8.1**
...
**Achieve Planner 1.9.6.0**
Feature: New Due Today & Due Tomorrow schedule status values for projects & tasks
Feature: New way of determining 'next actions' for a project when using the simpler/basic definition. Next actions are all tasks that have the highest priority value under a project ([see here for details](next-action-list.md))
...
Bugfix - Recurring instances for projects/tasks not generated when task completed during sync
Various other bugfixes and enhancements
**Achieve Planner 1.6.1.0**
Fature/Bugfix - Additional support/enhancements to reduce Outlook appointment duplication during sync - [ Click here for additional information](support/removing-duplicate-appointments.md) about removing duplicated appointments
...
Various other bugfixes and enhancements
**Achieve Planner 1.6.0.2**
Bugfix - Fix a problem introduced in 1.6.0.1 importing data files from older AP versions
**Achieve Planner 1.6.0.1**
...
Feature: BETA Achieve Planner ActiveSync provider for Pocket Informant sync - [Click here for sync beta details](beta/achieve-planner-PI-sync-beta.md) (the sync remains in beta until further notice)
...
**Achieve Planner 1.5.2.1**
Bugfix - Fix a problem with data conversion from previous releases and Quick Task Entry
**Achieve Planner 1.5.2.0**
Feature - Put project name at start in Tasks tab project dropdown
Feature - Integration of projects and goals (Projects and Outline tab). [ Click here](http://www.effexis2.com/forum/showpost.php?p=2858&postcount=2) for a more detailed description of the changes.
...
**Achieve Planner 1.4.1.1**
The 1.4.1.1 release is a free update for all existing 1.x users.
...
**Achieve Planner 1.4.1.0**
The 1.4.1.0 release is a free update for all existing 1.x users.
...
**Achieve Planner 1.4.0.2**
The 1.4.0.2 release is a free update for all existing 1.x users.
...
New Features:
\+ [ Project/Task Attachments](features/project-task-attachments.md)
\+ [Task Chooser](online_documentation/taskchooser.md)
\+ [ Project/Task Recurrence](features/recurring-projects-tasks.md)
...
- Ability to change reminder sound by placing a 'reminder.wav' file in application directory
  **Achieve Planner 1.1.11 Release**
  ...
  [ BR#58 - Achieve Planner not releasing Outlook process during Sync](../phpBB2/viewtopic.php__t_98.md) (Fixed)
  BR#59 - Notes editor adds trailing non-URL character(s) to pasted URLs (Fixed)
  [ BR#60 - Grouping problem when first loading Achieve Planner task list](../phpBB2/viewtopic.php__t_110.md) (Fixed)
  [ BR#61 - Problem setting label on recurring appointment instance](../phpBB2/viewtopic.php__t_121.md) (Fixed)
  [ BR#47 - Data error when deleting an address](../phpBB2/viewtopic.php__t_66.md) (Fixed)
  ...
  **Release 1.1.10**
  New Features:
  New: [Automatic backup of data files](features/automatic-backup.md)
  Changes/fixes:
