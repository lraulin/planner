# Standards for Payees — one merchant identity

The following standards apply to this work. Copied in full, per the house pattern of
the last three Actual specs — a frozen spec should not depend on a file that may have
moved on.
