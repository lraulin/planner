# Standards for Register prepared rows

Applied as of standards commit `0b12a69`. References, not copies — see AGENTS.md.
...
<!-- The standards text was formerly inlined here. It lives in agent-os/standards/
     and, as it stood at freeze, in `git show 0b12a69:agent-os/standards/<path>.md`. -->
