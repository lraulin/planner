...
| 2   | Merchant→category remains the ceiling of this spec. AI classification and purpose-not-vendor (Amazon/Walmart, PayPal) parked on the roadmap, not opened here. | The bank line names who was paid, not what it was for. More aliases cannot tell a Walmart grocery run from formula, or an Amazon C4 order from a kettlebell. That needs a later pass (likely AI + override) once spend is already honest.                                 |
