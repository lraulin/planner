...
The following standards apply to this work. Full text, copied at shaping time.

---

## development/testing

**Why it applies:** Permission/copy rules live in lib with a sibling test. No component tests, no DB.
...
**Why it applies:** One concept (`restNotify`), no speculative notify bus. Side effects stay in RestTimer.
...
**Why it applies:** Immediate, clear feedback when rest ends. No new chrome on the rest strip.
...
**Why it applies:** This exists because of the phone at the gym. The strip layout does not change.
