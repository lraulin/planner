...
| #   | Change                                                                                                                                                                                                                                                                                                            | Why                                                                                                                                                                                            |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | D1: pagination, search and filter checks stay page-wide instead of scoped to the current-cycle region.                                                                                                                                                                                                            | They only ever refuse a capture; scoping them would loosen a fail-closed check without DOM evidence. Only the emptiness/completeness assertions that could _grant_ trust are scoped.           |
| 2   | D1/D2 userscript changes were written without saved HTML of the statement-close page (none is in the repo). Regions are found by heading text; a region whose container is shared with another heading is unreadable.                                                                                             | Fail closed. **Unverified against the live Capital One and Chase DOM** — the first real paste after install is the test.                                                                       |
| 3   | D2: shape is `recentPosted` rows plus `recentStatementClosedOn`, with `completeness.recentPosted`.                                                                                                                                                                                                                | A sibling key keeps the rows a plain array.                                                                                                                                                    |
| 4   | D4: the snapshot audit's before-state and the register delete audit gained description, notes, payee and feed identity. The premise that `before_fields` "keeps the full row" was false; the Sep 20 event predates this and is restored by naming the hold from its own `rawText` (unique amount+day match only). | Restore needs a whole row.                                                                                                                                                                     |
| 5   | D4: only pending holds restore, and the pairing check is `resolveLostHold`, refusing when any posted candidate exists.                                                                                                                                                                                            | A restored posted row would duplicate its own re-delivery.                                                                                                                                     |
| 6   | D3: the register shows an Unlisted badge; resolve is the existing audited register delete. **The Accounts-page surface was not built.**                                                                                                                                                                           | The delete already had confirmation and audit; an Accounts count is a follow-up.                                                                                                               |
| 7   | D5: a vanished SimpleFIN hold with no or ambiguous successor is kept and flagged.                                                                                                                                                                                                                                 | One rule for both pipelines.                                                                                                                                                                   |
| 8   | Task 1 (recover Chewy) is **not done**: it needs the deployed app and production data. After deploy, open `/finances/activity?event=<the 2026-09-20 event>` and press "Restore this hold".                                                                                                                        | Nothing here reaches production.                                                                                                                                                               |
| 9   | `resolveLostHold` also accepts a same-merchant posted row up to 50% larger than the hold (a tip), besides Actual's 7.5% band.                                                                                                                                                                                     | Kim's Nails III, 2026-09-21: a $50 hold posted at $60. The 7.5% band is a rule-matching tolerance, not a tip, so D3 kept the hold beside its own posting. Description gates the tip case only. |
